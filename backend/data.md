...
Python, C++, C, SQL, TensorFlow, PyTorch, Scikit-learn, XGBoost, Random Forest, SVM, KNN, Gradient Boosting, OpenCV, YOLO, NLP, LangChain, LlamaIndex, RAG Pipelines, Vector Databases, Pandas, NumPy, SHAP, Data Science, MLOps, Docker, CI/CD, GitHub Actions, FastAPI, Git & GitHub, Jupyter Notebooks, VS Code
...
## Intel Unnati Program | AI/ML Trainee
...
## IEEE GRSS | Executive Member
**Period:** 2023 – Present
- Organized technical seminars and workshops, increasing student participation by 25% year-on-year.

## INICIA, Dept. of ECE | Senior WebMaster
**Period:** 2023 – Present
- Led departmental web initiatives, improving digital engagement by 20% through optimized event platforms.

## Python Workshop, Dept. of ECE | Student Instructor
**Period:** 2024
- Delivered a hands-on Python programming workshop training 50+ students in core programming concepts and practical ML applications.
...
## Ambulance Traffic Prediction System
